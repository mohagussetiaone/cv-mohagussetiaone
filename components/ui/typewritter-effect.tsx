...
export const TypewriterEffect = ({
  ...
  return (
    <div className={cn("text-4xl md:text-4xl lg:text-5xl font-bold text-start", className)}>
      {renderWords()}
      <motion.span
        initial={{
          opacity: 0,
        ...
        className={cn("inline-block rounded-sm w-[4px] h-4 md:h-6 lg:h-10 bg-brand-500", cursorClassName)}
      ></motion.span>
    </div>
  );
};
