...
export const projectData: Project[] = [
  ...
  {
    product_id: 3,
    project_name: "Selaras Invite",
    description: "description_project_3",
    image: "/project/selaras-invite.png",
    technologies: [Technology.NEXT_JS, Technology.TAILWIND_CSS, Technology.AXIOS, Technology.SUPABASE, Technology.PRISMA],
  ...
  },
  {
    ...
    description: "description_project_9",
